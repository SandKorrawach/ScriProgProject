...
% The state-space matrices for the missiles's longitudinal dynamics.
% Calculated from one of the missile from Raytheon missilese and defense
% These matrices describe how the system evolves over time
A = [-1.064 1.000; 290.26 0.00];        %State Matrix
B = [-0.25; -331.40];                   %Input Matrix
C = [-123.34 0.00; 0.00 1.00];          %Output Matrix
D = [-13.51; 0];                        %Feedforward Matrix
